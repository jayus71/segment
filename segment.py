...
def load_file_segment():
    ...
    # 加载我们自己的词典
    f = codecs.open(u"record.txt", 'r', encoding='utf-8')
    # 打开文件
    content = f.read()
    # 读取文件到content中
    f.close()
...
df1 = pandas.DataFrame(words_count)
df1.to_csv(r'C:\Users\Jayus\Desktop\seg\1.csv',index=False)
# 获得词语和频数
